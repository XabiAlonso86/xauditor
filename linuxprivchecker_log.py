...
def createLogger(mainPath):
    ...
    # Creamos el logger
    logger = logging.getLogger("linuxprivcheck_log")
    ...
    fh = logging.FileHandler(mainPath + '/linuxprivcheck_log@%s.log' % time.strftime("%H_%M_%S"))
